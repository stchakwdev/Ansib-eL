...
from ansibel.orchestrator import Orchestrator, Task, TaskBreakdown
from ansibel.git_wrapper import GitWrapper, AgentMetadata
from ansibel.agent_system import AgentManager, Agent, AgentStatus
from ansibel.tournament import TournamentOrchestrator, Tournament, SelectionMode
from ansibel.trust_lineage import TrustLineageManager, TrustTier, DecisionType
...
class AnsibElSystem:
    ...
    def review_and_approve(self, approval_id: str, approve: bool, 
        ...
        if approve:
            ...
            if result.success and result.solution:
                agent_uuid = result.solution.agent_id
                if isinstance(agent_uuid, str):
    ...
    def list_pending_approvals(self) -> List[Dict[str, Any]]:
        ...
        return [
            {
                'id': str(a.id),
                'title': a.solution.task.description if a.solution.task else "Unknown",
    ...
    def _run_tournament_task(self, task: Task, num_agents: int) -> Dict[str, Any]:
        ...
        from ansibel.tournament import AgentConfig, Task as TournamentTask
    ...
    def _create_human_interface(self):
        ...
        from ansibel.orchestrator import HumanInterface
